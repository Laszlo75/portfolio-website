...
**Next in this series:** the same verified-citation engine, running itself on a schedule. [From a literature-search skill to a self-running evidence digest](/posts/automated-literature-watch/) describes how Kidney Watch turns this workflow into an automated weekly digest that publishes to the web.
