...
![](hero.png){fig-alt="Flat vector illustration of a markdown document on the left transforming through a pandoc conversion pipeline into a styled Word document on the right, with teal and coral accents showing evidence grades, clickable links, and a summary table"}
